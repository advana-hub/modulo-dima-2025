...
@app.cell
def _(mo):
    mo.md(r"""Definiamo qualche funzione utile per visualizzare dati e output dei modelli della lezione.""")
    return
...
@app.cell
def _(mo):
    mo.md(r"""Come possiamo migliorare il clustering del KMeans su questo dataset?""")
    return
